...
create_clock -name sys_clk -period 15.0 [get_ports {clk}]
set_input_delay -clock clk 2 [get_ports {resetn}]
set_input_delay -clock clk 2 [get_ports {start}]
set_output_delay -clock clk 3 [get_ports {max_index[*]}]
set_output_delay -clock clk 3 [get_ports {img[*]}]
set_output_delay -clock clk 3 [get_ports {done}]
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {max_index[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {max_index[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {max_index[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {max_index[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {done}];          # "LD4"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {img[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {img[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {img[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {img[3]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {img[4]}];  # "SW4"
...
set_property IOSTANDARD LVCMOS33 [get_ports {max_index[*]}]
set_property IOSTANDARD LVCMOS33 [get_ports {img[*]}]
